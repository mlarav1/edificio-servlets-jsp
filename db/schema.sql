...
-- Tokens de recuperacion de clave: solo se guarda el hash SHA-256 del token. Tabla aparte para que
-- Usuario conserve exactamente sus cuatro atributos. (La aplicacion tambien la crea si no existe.)
